...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('campaign_histories', function (Blueprint $table) {
            ...
            $table->double('level_6')->default(0);
            $table->double('level_7')->default(0);
            $table->double('level_8')->default(0);
            $table->double('level_9')->default(0);
            $table->double('level_10')->default(0);
            $table->unsignedBigInteger('campaign_id')->index('campaign_histories_campaign_id_foreign');
            $table->timestamps();
        });
    }
