...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_subs', function (Blueprint $table) {
            ...
            $table->foreignId("product_list_id")->constrained("product_lists", "id","product_list_sub_pk");
            $table->foreignId("product_cat_id")->constrained("product_cats", "id", "product_cat_sub_pk");
            $table->foreignId("product_item_id")->constrained("product_items", "id","product_item_sub_pk");
