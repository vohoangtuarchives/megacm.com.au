...
$menu = [
    ...
    [
        "key"   => "locations",
        "title" => "admin.menu.locations.title",
        "icon"  => "ri-account-circle-line",
    ...
    [
        "key"   => "cart",
        "title" => "admin.menu.cart.title",
        "icon"  => "ri-account-circle-line",
        "route" => "dashboard.cart.items.index",
        'sort'       => 1,
    ],
    [
        "key"   => "cart.items",
        "title" => "admin.menu.cart.items.title",
        "icon"  => "ri-account-circle-line",
        "route" => "dashboard.cart.items.index",
        'sort'       => 1,
    ],
