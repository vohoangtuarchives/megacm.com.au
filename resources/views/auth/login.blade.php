                                ...
                                <div class="p-2 mt-4">
                                    <form action="{{ route('dashboard.login') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" id="username" name="email" placeholder="Email">
                                            @error('email')
...
@push("style")
   <style>
       ...
       .btn-login:hover, .btn-login:focus{
           background-color: #0678bd!important;
           border-color: #0678bd!important;
           color: #fff!important;
       }
   </style>
@endpush