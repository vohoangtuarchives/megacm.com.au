            ...
            <div class="h-100">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <x-dashboard.widgets.info title="Đăng ký mới" counter="{{$customers->count()}}"></x-dashboard.widgets.info>
                    </div><!-- end col -->
                </div>
            </div> <!-- end .h-100-->
        </div> <!-- end col -->
...
@section('script')
    <script>
        ...
        startItemPicker = document.getElementById("startPicker");
        endItemPicker = document.getElementById("endPicker");

        startPicker = flatpickr(startItemPicker, timeData);
        endPicker = flatpickr(endItemPicker, timeData);
    </script>
@endsection
@push("css")
    <style>
