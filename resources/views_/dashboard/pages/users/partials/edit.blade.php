                        ...
                        @endphp
                            <select name="role" class="form-select">
                                @foreach($roles as $role)
                                    @if($user->getRole()->code == $role->code ||
                                    core()->can(\Illuminate\Support\Facades\Auth::user())->check("dashboard.roles
                                    .edit"))
                                        <option value="{{ $role->id }}" @if($user->getRole()->code == $role->code) selected
