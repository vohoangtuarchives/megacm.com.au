            ...
            <div class="row g-1">
                <div class="col-lg-8">
                    @section("blog-content")
                        @isset($newestBlog)
                            <div class="blog-newest-content __content p-3 d-flex flex-wrap ">
                               <div class="blog-large-item">
                                   <div class="blog-image mb-3">
                                       <img src="{{ $newestBlog->photo }}" alt="{{ $newestBlog->name }}" class="w-100 img-fluid">
                                   </div>
                                   <h3 class="mb-3"><a href="{{ route("home.blog.item", $newestBlog->slug) }}"><span>{{ $newestBlog->name }}</span></a></h3>
                                   <div class="blog-desc">
                                       {{ $newestBlog->desc }}
                                   </div>
                               </div>
                        ...
                        <ul class="blog-services list-unstyled p-0">
                            <li>
                                <a href="{{ route("home.services.service", 'house-cleaning') }}">
                                    <div class="side-img">
                                        <img decoding="async" src="{{ asset("images/vector_smart_object27.png") }}"
                                             alt="house"
                                             ></div>
                            ...
                            <li>
                                <a href="{{ route("home.services.service", 'office-cleaning') }}">
                                    <div class="side-img">
                                        <img src="{{ asset("images/vector_smart_object17.png") }}"
                                             alt="vector_smart_object17">
                                    </div>
                            ...
                            <li>
                                <a href="{{ route("home.services.service", 'regular-cleaning') }}">
                                    <div class="side-img">
                                        <img src="{{ asset("images/vector_smart_object18.png") }}"
                                             alt="vector_smart_object18">
                                    </div>
                            ...
                            <li>
                                <a href="{{ route("home.services.service", 'end-of-lease-cleaning') }}">
                                    <div class="side-img">
                                        <img src="{{ asset("images/vector_smart_object19.png") }}"
                                             alt="vector_smart_object19">
                                    </div>
                            ...
                            <li>
                                <a href="{{ route("home.services.service", 'deep-cleaning') }}">
                                    <div class="side-img">
                                        <img src="{{ asset("images/vector_smart_object20.png") }}"
                                             alt="vector_smart_object20">
                                    </div>
                            ...
                            <li>
                                <a href="{{ route("home.services.service", 'construction-cleaning') }}">
                                    <div class="side-img">
                                        <img src="{{ asset("images/vector_smart_object24.png") }}"
                                             alt="vector_smart_object24">
                                    </div>
                            ...
                            <li>
                                <a href="{{ route("home.services.service", 'ndis-cleaning') }}">
                                    <div class="side-img">
                                        <img src="{{ asset("images/vector_smart_object25.png") }}"
                                             alt="vector_smart_object25">
                                    </div>
                            ...
                            <li>
                                <a href="{{ route("home.services.service", 'oven-cleaning') }}">
                                    <div class="side-img">
                                        <img src="{{ asset("images/vector_smart_object26.png") }}"
                                             alt="vector_smart_object26">
                                    </div>
