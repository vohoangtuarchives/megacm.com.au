                ...
                <div class="col-lg-7 col-12 d-flex justify-content-lg-end">
                   <div class="d-flex flex-column">
                       <div class="textwidget mb-4">
                           <h3>GET IN TOUCH</h3>
                           <p><strong>{{ core()->getSetting("site_title") }}</strong><br>
                               <strong>Phone:</strong> <a href="tel:{{ core()->getSetting("address") }}">{{ core()->getSetting("hotline")
                               }}</a><br>
                               <strong>Email:</strong> <a href="mailto:sales@megacm.com.au">{{ core()->getSetting
                               ("email") }}</a><br>
